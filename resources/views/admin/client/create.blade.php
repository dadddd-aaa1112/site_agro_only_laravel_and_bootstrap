...
@section('content')
    ...
    <form class="w-25" action="{{route('admin.client.store')}}" method="post">
        ...
        <div class="mb-3">
            ...
            <input value="{{old('contract_date')}}" name="contract_date" type="date" class="form-control" placeholder="дата контракта">
        ...
        <div class="mb-3">
            ...
            <input value="{{old('cost_deliveries')}}" name="cost_deliveries" type='number' step='0.01' class="form-control" placeholder="цена заказа" >
